...
@click.command()
@click.option('--path', '-p', default=1, help='Cesta ke konfiguračnímu souboru s přístupovými údaji.')
@click.option('--expression', '-e', default='python', help='Hledaný výraz.')
@click.option('--onload', '-o', default=10, help='Počet na začátku načtených tweetů.')
@click.option('--time', '-t', default=100, help='Časový interval dalších dotazů.')
@click.option('--retweet', '-r', default=True, help='Zobrazovat retweeety?')
